...
if (($VALIDADO==1) && ($tipo_usuario==0) )//Si el usuario se ha validado   y es administrador
{
  ...
  // Si el fornulario ha sido enviado -> Se valida noy hay errores en la introducci�n de datos
  if (isset($modificar) )
  {

      // Comprobaci�n de  que se han introducido todos los datos obligatorios

      if (strcmp(trim($nombre),"")==0)
      {
         $errores["nombre"] = "�Hay que introducir el t�tulo de la pelicula!";
         $error = true;
      }
      else
         $errores["nombre"] = "";
      ...
      {
         $errores["director"] = "�Hay que introducir el director de la pel�cula!";
         $error = true;
      }
      else
         $errores["director"] = "";
...
?>
     ...
     <tr border="0">
      ...
      <tr border="1">
          <td colspan="4" class="formularioTitulo"> Pel�cula modificada correctamente</td>
      </tr>
...
?>
     ...
     <tr border="0">
      ...
      <tr border="1">
          <td colspan="4" class="formularioTitulo"> MODIFICAR PEL�CULA </td>
      </tr>
  ...
  ?>
      ...
      <tr >
          ...
          <td class="formulario">Todos los p�blicos</td>
