...
**                                   reportar el bug.
**  Versi�n 1.5.0   (03/11/2004):   -Se agreg� la opci�n de elegir si se hace el conteo desde mySQL (COUNT(*)) o desde PHP (mysqli_num_rows()).
 ...
 * $_pagi_result        Identificador del resultado de la consulta a la BD para los registros de la p�gina actual. 
                Listo para ser "pasado" por una funci�n como mysqli_fetch_row(), mysqli_fetch_array(), 
