...
if (empty($_GET['_pagi_pg'])) {
    ...
    // La página actual seró la que se pidió.
...
if (false == $_pagi_conteo_alternativo) {
    ...
    $_pagi_result3 = mysqli_query($con, $_pagi_sql);
    // Si ocurrió error y mostrar errores está activado
    if (false == $_pagi_result3 && true == $_pagi_mostrar_errores) {
...
if (!isset($_pagi_propagar)) {
    ...
    // Eliminamos esa variable del $_GET
...
// La variable $_pagi_nav_num_enlaces sirve para definir cántos enlaces con
...
$_pagi_result = mysqli_query($con, $_pagi_sqlLim);
// Si ocurrió error y mostrar errores est activado
if (false == $_pagi_result && true == $_pagi_mostrar_errores) {
