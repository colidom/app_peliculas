...
if ((1 == $VALIDADO) && (0 == $tipo_usuario)) //Si el usuario se ha validado   y es administrador
{
    ...
    if (isset($insertar)) {
        ...
        else if (UPLOAD_ERR_FORM_SIZE == $_FILES['imagen']['error']) {
        ...
        if (false == $error) //Si no hay errores al introducir los datos
        {
    ...
    if (isset($insertar) && false == $error && false == $existePelicula) {
...
$conexion->cerrar_conexion();
  ...
  <?php
      ...
      <tr border="1">
          ...
          <td class="formulario" colspan="3"> <input type="text" name="nombre" size="50" maxlength="50" value="<?php if (isset($nombre)) {
            echo $nombre;
        }
        ?>" > </td>
      </tr>
...
if (isset($errores["nombre"]) && ("" != $errores["nombre"])) {
      ...
      <tr >
          ...
          <td class="formulario">
               <select name="genero" size="1" >
                  <option value="Aventuras" <?php if (isset($genero) && strcmp($genero, 'AVENTURASD') == 0) {
            echo " selected=\"true\"";
        }
        ?>>Aventuras</option>
                  <option value="Terror" <?php if (isset($genero) && strcmp($genero, 'TERROR') == 0) {
            echo " selected=\"true\"";
        }
        ?> >Terror</option>
                  <option value="Comedia" <?php if (isset($genero) && strcmp($genero, 'COMEDIA') == 0) {
            echo " selected=\"true\"";
        }
        ?> >Comedia</option>
                  <option value="Accion" <?php if (isset($genero) && strcmp($genero, 'ACCION') == 0) {
            echo " selected=\"true\"";
        }
        ?> >Accion</option>
                  <option value="Belica" <?php if (isset($genero) && strcmp($genero, 'BELICA') == 0) {
            echo " selected=\"true\"";
        }
        ?> >Belica</option>
                  <option value="Drama" <?php if (isset($genero) && strcmp($genero, 'DRAMA') == 0) {
            echo " selected=\"true\"";
        }
        ?> >Drama</option>
                  <option value="Suspense" <?php if (isset($genero) && strcmp($genero, 'SUSPENSE') == 0) {
            echo " selected=\"true\"";
        }
        ?> >Suspense</option>
                  <option value="C. Ficcion" <?php if (isset($genero) && strcmp($genero, 'C. FICCION') == 0) {
            echo " selected=\"true\"";
        }
        ?> >C.Ficcion</option>
               </select>
          ...
          <td class="formulario" > SI <input type="radio" name="publico" value="1" <?php if (!isset($publico) || 1 == $publico) {
            echo "checked";
        }
        ?> > NO <input type="radio" name="publico" value="0"  <?php if (isset($publico) && 0 == $publico) {
            echo "checked";
        }
        ?> ></td>
      </tr>
      <tr >
           ...
           <td class="formulario" colspan="3"> <input type="text" name="director" size="50" maxlength="50" value="<?php if (isset($director)) {
            echo $director;
        }
        ?>"> </td>
      </tr>
...
if (isset($errores["director"]) && ("" != $errores["director"])) {
      ...
      <tr >
          ...
          <td class="formulario" colspan="3"> SI <input type="radio" name="estreno" value="1" <?php if (!isset($estreno) || 1 == $estreno) {
            echo "checked";
        }
        ?> > NO <input type="radio" name="estreno" value="0"  <?php if (isset($estreno) && 0 == $estreno) {
            echo "checked";
        }
        ?> ></td>
      </tr>
