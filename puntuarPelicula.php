...
//Si se ha enviado el formulario y  no hay errores
    if (isset($puntuar)) {
        ...
        $result_query = mysqli_query($con, $sql_query) or die("Error en la sentencia SQL<br><br>" . $sql_query . "<br><br>");
        ...
        if ($reg_query) //El usuario ya ha puntuado esa pelicula  -> se actualiza su puntuación
        {
            ...
            $result_update = mysqli_query($con, $sql_update) or die("Error en la sentencia SQL<br><br>" . $sql_update . "<br><br>");
            if (trim($comentario) == "") {
        ...
        } else //el usuario no ha puntuado la película
        {
            ...
            $result_update = mysqli_query($con, $sql_insert) or die("Error en la sentencia SQL<br><br>" . $sql_insert . "<br><br>");
    ...
    $result_pelicula = mysqli_query($con, $sql_pelicula) or die("Error en la sentencia SQL<br><br>" . $sql . "<br><br>");
    ...
    if ($reg_pelicula) {
        ...
        ?>
          ...
          <tr >
              ...
              <td class="datos" width="300"> <?php if (1 == $reg_pelicula["estreno"]) {
            echo "SI";
        } else {
            echo "NO";
        }
        ?>  </td>
          ...
          <tr >
              ...
              <td class="datos"width="300" > <?php if (1 == $reg_pelicula["publico"]) {
            echo "SI";
        } else {
            echo "NO";
        }
...
//Se obtiene la puntuacion media de la pelicula
        ...
        if (null != $reg_puntuacion["ROUND(AVG(puntuacion),2)"]) {
            ?>
              <tr >
...
<?php
        ...
        ?>
              ...
              <tr>
<?php
if (0 == $tipo_usuario) //Si el usuario es administrador
        {
            ?>
