...
if ($VALIDADO==1)
{
   ...
   echo "<table width=\"700\" border=\"0\" align=\"center\" cellspacing=\"0\">";
        ...
        $result = mysqli_query($con, $sql) or die("Error en la sentencia SQL<br><br>".$sql_puntuacion."<br><br>");
        ...
        if ($reg!=NULL)
        {
          ...
          {
               echo "<tr> ";
                 echo "<td width=\"700\" class=\"mostrar\" >NO EXISTE IMAGEN PARA LA PEL�CULA</td>";
               echo "</tr>";
