...
//Se controla si se ha iniciado sesi�n ( el usuario se ha validado)
...
if ($VALIDADO==1)
{
   ...
   foreach($_POST as $nombre_campo => $valor)
   {
    ...
    // *** Iniciacion de variables para el script de paginaci�n ***
    ...
    // *** Construcci�n de la consulta de b�squeda ***
