...
if (isset($insertar) && false == $error && false == $existeUsuario) {
...
if (isset($errores["password"]) && ("" != $errores["password"])) {
    ...
    <tr border="0">
         ...
         <td colspan="3"class="formulario" > <input type="text" name="nombre" size="10" maxlength="30" value="<?php if (isset($nombre)) {
        echo $nombre;
    }
    ?>"> </td>
    </tr>
...
if (isset($errores["nombre"]) && ("" != $errores["nombre"])) {
    ...
    <tr border="0">
         ...
         <td class="formulario" colspan="3"> <input type="text" name="apellidos" size="30" maxlength="30" value="<?php if (isset($apellidos)) {
        echo $apellidos;
    }
    ?>"> </td>
    </tr>
    <tr border="0">
         ...
         <td class="formulario" colspan="3"> <input type="text" name="email" size="30" maxlength="30" value="<?php if (isset($email)) {
        echo $email;
    }
    ?>"> </td>
    </tr>
